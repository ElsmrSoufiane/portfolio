          ...
          @foreach ($conversations as $conv)
            <button type="button"
              ...
              <div class="relative">
                ...
                <span class="absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-sky-500 @if (str_contains($conv['status'], 'Online')) bg-emerald-400 @else bg-slate-300 @endif"></span>
              </div>
        ...
        <header id="chat_header_618305" class="flex min-h-30 items-center justify-between border-b border-sky-200 bg-sky-500 px-5 shadow-[0_4px_6px_rgba(14,116,144,0.18)] sm:px-8">
          <div id="person_info_274930" class="flex items-center gap-3">
            <div id="avatar_wrap_905172" class="relative">
              ...
              <span id="online_dot_761204" class="absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-sky-500 @if (str_contains($conversation['status'], 'Online')) bg-emerald-400 @else bg-slate-300 @endif"></span>
            </div>
